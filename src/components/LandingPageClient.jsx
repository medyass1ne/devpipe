      ...
      <header className="flex items-center justify-between p-6 border-b border-surface-raised max-w-7xl mx-auto w-full">
        <div className="flex items-center space-x-8">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <a href="https://github.com/medyass1ne/devpipe" target="_blank" rel="noreferrer" className="text-text-muted hover:text-text-main transition" aria-label="GitHub Repository">
